...
import { FlowText, GooBlob, Shimmer, LineReveal, ClipReveal, StaggerGroup, popItem } from '../components/motionx';
  ...
  return (
    <div>
      ...
      <section style={{ position: 'relative', minHeight: '78vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--nav-h)', overflow: 'hidden' }}>
        ...
        <GooBlob size={480} color="var(--glow-azure)" duration={21} style={{ position: 'absolute', top: '6%', right: '-4%', zIndex: 0 }} />
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 0.9fr', gap: 48, alignItems: 'center' }}>
            <Reveal>
              ...
              <LineReveal as="h1" className="h-display" style={{ marginBottom: 22 }} lines={[<>Let&rsquo;s <FlowText key="f">Connect.</FlowText></>]} />
      ...
      <section id="details" className="section-pad" style={{ paddingTop: 20, scrollMarginTop: 88 }}>
        <div className="container">
          <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 24, alignItems: 'start' }}>
            ...
            <ClipReveal direction="left" radius={30} frostBorder={false}>
              <Shimmer className="console" radius={30} period={6} style={{ padding: 'clamp(26px,3vw,40px)' }}>
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <StaggerGroup style={{ display: 'grid', gap: 12 }}>
                    {expect.map(([t, ic], i) => (
                      <motion.div key={i} variants={popItem} style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
