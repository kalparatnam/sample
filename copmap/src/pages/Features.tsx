...
export default function Features() {
  ...
  return (
    <div>
      ...
      <section style={{ position: 'relative', minHeight: '84vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--nav-h)', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          <Reveal>
            ...
            <h1 className="h-display" style={{ margin: '0 auto 22px', maxWidth: '15ch' }}>Every Feature Your <span className="grad">Force Needs.</span></h1>
          ...
          <div className="explorer" style={{ display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 24, alignItems: 'start' }}>
            ...
            <div className="glass" style={{ padding: 'clamp(26px,3.4vw,42px)', minHeight: 460 }}>
              <AnimatePresence mode="wait">
                <motion.div key={active} initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} transition={{ duration: 0.4 }}>
      ...
      <section id="stack" className="section-pad" style={{ scrollMarginTop: 88 }}>
        <div className="container">
          ...
          <div className="col-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 18 }}>
            {diffs.map(([t, b, ic, c], i) => (
              <Reveal key={i} delay={i * 0.1}>
                <TiltCard className="glass glass-hover" style={{ padding: 32, height: '100%' }}>
                  <div style={{ width: 54, height: 54, borderRadius: 15, display: 'grid', placeItems: 'center', color: c as string, background: `color-mix(in srgb, ${c} 12%, transparent)`, border: `1px solid color-mix(in srgb, ${c} 28%, transparent)`, marginBottom: 20 }}>{ic}</div>
